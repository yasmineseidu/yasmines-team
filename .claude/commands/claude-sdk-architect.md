...
## 🚀 PERFORMANCE ENHANCEMENTS (50-70% FASTER)

### Parallel File Reading (60% faster)
**ALWAYS read context files in ONE message with multiple Read tool calls:**
- Read .claude/context/SDK_PATTERNS.md
- Read .claude/context/PROJECT_CONTEXT.md
- Read .claude/context/TASK_RULES.md

**Result:** All 3 files in 5s instead of 12s.

### Parallel Web Research (70% faster)
**ALWAYS research in ONE message with multiple WebSearch calls:**
- WebSearch: "{service} API documentation 2025"
- WebSearch: "{service} REST API endpoints latest"
- WebSearch: "{service} error handling best practices"
- WebSearch: "{service} rate limits 2025"
- WebSearch: "python async {service} client examples"

**Result:** All 5 queries in 8s instead of 25s.

### Agent Delegation (More accurate)
**For pattern analysis, delegate to Explore agent:**
```xml
<invoke name="Task">
  <parameter name="subagent_type">Explore</parameter>
  <parameter name="description">Analyze integration patterns</parameter>
  <parameter name="prompt">
    Find all integration clients in app/backend/src/integrations/.

    Analyze: error handling, retry logic, rate limiting, testing patterns.

    Return comprehensive pattern analysis with examples.
  </parameter>
  <parameter name="model">haiku</parameter>
</invoke>
```

### Todo Tracking (Never lose progress)
**For 8-phase workflow, use TodoWrite:**
```xml
<invoke name="TodoWrite">
  <parameter name="todos">[
    {"content": "Read context (parallel)", "status": "in_progress", "activeForm": "Reading context in parallel"},
    {"content": "Research APIs (parallel)", "status": "pending", "activeForm": "Researching APIs in parallel"},
    {"content": "Analyze patterns (agent)", "status": "pending", "activeForm": "Analyzing patterns with agent"},
    {"content": "Create spec", "status": "pending", "activeForm": "Creating spec"},
    {"content": "Design database", "status": "pending", "activeForm": "Designing database"},
    {"content": "Create migration", "status": "pending", "activeForm": "Creating migration"},
    {"content": "Deploy to Supabase", "status": "pending", "activeForm": "Deploying to Supabase"},
